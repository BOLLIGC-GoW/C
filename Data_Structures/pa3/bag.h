...
/*	
   palindrome(const bag& b1)
	
	Precondition: a bag of the same type is passed to the function

	Postcondition: a bag is returned that contains twice the 'used' space as the 
	bag that was passed to it, and the data array is a palindrome of the original
	bag's data array.
